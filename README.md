...
| [Negated classes] (`[!abc]`)                        | Y           | Y      | Y        | Y           | N            | tinyglobby: returns inverted results for negated character classes [1]; glob: results in indeterminate order, manual sorting required |
| [Question mark] (`?`)                               | Y           | Y      | Y        | N           | Y            | tiny-glob: globalyzer (subdep) doesn't recognize `?` as glob pattern [2]                                                                              |
| **Globstar**                                        |
...
[1] **tinyglobby negated character classes bug:**

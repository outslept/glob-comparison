...
| **Path Handling**                                   |
| Absolute paths                                      | Y           | Y       | Y        | Y           | Y            | [`glob`], [`tiny-glob`]: use backslashes on Windows [\[12\]](#12-path-separator-differences-on-windows); [\[1\]](#1-indeterminate-result-ordering)                                                                                              |
| Relative paths                                      | Y           | Y       | Y        | Y           | Y            | [`glob`], [`tiny-glob`]: use backslashes on Windows [\[12\]](#12-path-separator-differences-on-windows); [\[1\]](#1-indeterminate-result-ordering)                                                                                              |

...
const FILES = [
  ...
  'app.js', 'app.ts', 'app.min.js', 'app.dev.js', 'app.prod.js',
  'test.js', 'test.spec.js', 'test.unit.js', 'test.config.js',
  'main.js', 'main.min.js', 'main.dev.js',
  'style.css', 'style.min.css', 'style.scss',
  'component.jsx', 'component.tsx', 'component.vue',
